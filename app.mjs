...
import { PayUSrv } from "@ejfdelgado/ejflab-back/srv/PayUSrv.mjs";
...
import { MfaSrv } from "@ejfdelgado/ejflab-back/srv/MfaSrv.mjs";
...
import { AudIASrv } from "@ejfdelgado/ejflab-back/srv/AudIASrv.mjs";
...
app.post('/srv/mfa/:pageId/imagesw', [commonHeaders, checkAuthenticatedSilent, AuthorizationSrv.hasPagePermisions([["fil_w"]]), express.json(), handleErrorsDecorator(MfaSrv.save)]);
app.post('/srv/mfa/:pageId/imagesr', [commonHeaders, checkAuthenticatedSilent, AuthorizationSrv.hasPagePermisions([["fil_r"]]), express.json(), handleErrorsDecorator(MfaSrv.read)]);
app.post('/srv/mfa/:pageId/imagesd', [commonHeaders, checkAuthenticatedSilent, AuthorizationSrv.hasPagePermisions([["fil_r"]]), express.json(), handleErrorsDecorator(MfaSrv.delete)]);
app.post('/srv/mfa/:pageId/computevector', [commonHeaders, checkAuthenticatedSilent, AuthorizationSrv.hasPagePermisions([["fil_r"]]), express.json(), handleErrorsDecorator(MfaSrv.computeVector)]);
app.post('/srv/mfa/:pageId/validateface', [commonHeaders, express.json({ limit: '50mb' }), checkAuthenticatedSilent, AuthorizationSrv.hasPagePermisions([["fil_r"]]), express.json(), handleErrorsDecorator(MfaSrv.validateFace)]);
app.post('/srv/mfa/:pageId/rotate', [commonHeaders, checkAuthenticatedSilent, AuthorizationSrv.hasPagePermisions([["fil_r"]]), express.json(), handleErrorsDecorator(MfaSrv.rotate)]);
app.post('/srv/mfa/:pageId/validateuid', [commonHeaders, checkAuthenticatedSilent, AuthorizationSrv.hasPagePermisions([["fil_r"]]), express.json(), handleErrorsDecorator(MfaSrv.validateuid)]);
app.post('/srv/mfa/:pageId/createenrollment', [commonHeaders, checkAuthenticatedSilent, AuthorizationSrv.hasPagePermisions([["fil_r"]]), express.json(), handleErrorsDecorator(MfaSrv.createUpdateEnrollmentLink)]);
app.get('/srv/mfa/:pageId/executeenrollment', [commonHeaders, express.json(), handleErrorsDecorator(MfaSrv.executeEnrollment)]);
...
app.post('/srv/audia/:pageId/audiosw', [commonHeaders, checkAuthenticatedSilent, AuthorizationSrv.hasPagePermisions([["fil_w"]]), express.json(), handleErrorsDecorator(AudIASrv.save)]);
app.post('/srv/audia/:pageId/audiosr', [commonHeaders, checkAuthenticatedSilent, AuthorizationSrv.hasPagePermisions([["fil_r"]]), express.json(), handleErrorsDecorator(AudIASrv.read)]);
app.post('/srv/audia/:pageId/audiosd', [commonHeaders, checkAuthenticatedSilent, AuthorizationSrv.hasPagePermisions([["fil_w"]]), express.json(), handleErrorsDecorator(AudIASrv.delete)]);
app.post('/srv/audia/:pageId/jobr', [commonHeaders, checkAuthenticatedSilent, AuthorizationSrv.hasPagePermisions([["fil_w"]]), express.json(), handleErrorsDecorator(AudIASrv.jobRead)]);
app.post('/srv/audia/:pageId/jobsr', [commonHeaders, checkAuthenticatedSilent, AuthorizationSrv.hasPagePermisions([["fil_w"]]), express.json(), handleErrorsDecorator(AudIASrv.jobsRead)]);
app.post('/srv/audia/:pageId/jobsw', [commonHeaders, checkAuthenticatedSilent, AuthorizationSrv.hasPagePermisions([["fil_w"]]), express.json(), handleErrorsDecorator(AudIASrv.jobsSave)]);
app.post('/srv/audia/:pageId/tagsw', [commonHeaders, checkAuthenticatedSilent, AuthorizationSrv.hasPagePermisions([["fil_w"]]), express.json(), handleErrorsDecorator(AudIASrv.tagsSave)]);
app.post('/srv/audia/:pageId/tagsr', [commonHeaders, checkAuthenticatedSilent, AuthorizationSrv.hasPagePermisions([["fil_w"]]), express.json(), handleErrorsDecorator(AudIASrv.tagsRead)]);
app.post('/srv/audia/:pageId/characterizevoice', [commonHeaders, checkAuthenticatedSilent, AuthorizationSrv.hasPagePermisions([["fil_w"]]), express.json(), handleErrorsDecorator(AudIASrv.characterizeVoice)]);
...
//app.post('/srv/imagiation/:pageId/startjob', [commonHeaders, checkAuthenticatedSilent, AuthorizationSrv.hasPagePermisions([["pg_w"]]), express.json(), handleErrorsDecorator(ImagiationSrv.tryStartJob)]);
//app.get('/srv/imagiation/watch', [commonHeaders, express.json(), handleErrorsDecorator(ImagiationSrv.watchServer)]);
//app.post('/srv/imagiation/watch', [commonHeaders, express.json(), handleErrorsDecorator(ImagiationSrv.watchServer)]);

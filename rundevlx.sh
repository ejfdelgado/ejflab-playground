...
export WORKSPACE=/home/ejfdelgado/desarrollo/widesight-core
export FACE_SERVER=http://localhost:8082/
export GOOGLE_APPLICATION_CREDENTIALS=/home/ejfdelgado/desarrollo/widesight-core/credentials/ejfexperiments-c2ef2a890ca5.json
